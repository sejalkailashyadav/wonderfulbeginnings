...
use App\Notifications\ChildStatusChanged;
use Notification;
use Carbon\Carbon;
 ...
 $daysOfWeek = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
    ...
    public function store(Request $r)
    {
        ...
        $data = $r->validate([
            ...
            'emergency_contact_relations' => 'nullable|max:100',
 ...
 $daysOfWeek = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
    ...
    public function update(Request $r, $id)
    {
        $rules = [
            ...
            'emergency_contact_name' => 'nullable|max:100',
            'emergency_contact_number' => 'nullable|digits_between:7,20',
            'emergency_contact_relations' => 'nullable',
            'emergency_contact_name2' => 'nullable|max:100',
...
if ($r->hasFile('child_picture')) {
  ...
  if ($r->input('action') === 'approve') {
    ...
    if (!isset($data['status']) || $data['status'] != 2) {
        ...
        // //child approve & withdorwn notifucnayion form admin checker 
        //     if ($data['status'] == 1) {
        //             Log::info('This is an informational message. sttaus 1 ');
        //         $admins = UserManagements::where('user_type', 'Admin')
        ...
        //         Log::info('This is an informational message. status 2 ');
        //          $admins = UserManagements::where('user_type', 'Admin')
        //         ->where(function ($query) use ($child) {
        //             $query->where('center_id', $child->center_id)
        //                   ->orWhere('center_id', 0);
