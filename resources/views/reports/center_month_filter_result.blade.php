        ...
        selects.forEach(select => {
            select.addEventListener('change', function () {
                ...
                document.getElementById(`accb_${index}`).value = accb.toFixed(2);
                 document.getElementById(`institution_number{index}`).value = institution_number;
                  document.getElementById(`transit_number{index}`).value = transit_number;
                   document.getElementById(`account_number{index}`).value = account_number;
