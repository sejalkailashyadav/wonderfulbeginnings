...
<div class="container">
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            {{-- Personal Info --}}
            <h5 class="text-primary border-bottom pb-1">Personal Information</h5>
            ...
            {{-- Parent Info --}}
            <h5 class="text-primary border-bottom mt-4 pb-1">Parent Information</h5>
            ...
            {{-- Withdrawal Details --}}
            <h5 class="text-primary border-bottom mt-4 pb-1">Withdrawal Details</h5>
            ...
            {{-- Sibling Info --}}
            <h5 class="text-primary border-bottom mt-4 pb-1">Sibling Information</h5>
