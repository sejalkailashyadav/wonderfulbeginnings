...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('employee_masters.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
                <label class="form-label">Designation</label>
                 <select name="designation" id="designation" class="form-select" onchange="toggledesignation()"></select>
        ...
        @enderror
            ...
            <div class="col-md-6" id="ece_license" style="display:none;">
        ...
        <select name="primary_location" id="institution_number" class="form-select"
            ...
            <div class="col-md-6" id="legal_work_doc">
             ...
             <div class="col-md-6" id="income_tax_forms">
